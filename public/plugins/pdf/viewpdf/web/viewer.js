    ...
    firstPagePromise.then(function (pdfPage) {
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee8(_ref2) {
          var _ref4, _ref4$, values, pageMode, openActionDest, initialBookmark, zoom, hash, rotation, sidebarView, scrollMode, spreadMode;
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  ...
                  if (openActionDest && !_this5.initialBookmark && !_app_options.AppOptions.get('disableOpenActionDestination')) {
                    _this5.initialBookmark = JSON.stringify(openActionDest);

                    _this5.pdfHistory.push({
